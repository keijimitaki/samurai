  ...
  <form>
    <div class="space-y-12">
      ...
      <div class="border-b border-gray-900/10 pb-12">
        <h2 class="text-base font-semibold leading-7 text-gray-900">OpenAI php client test</h2>
        <p class="mt-1 text-sm leading-6 text-gray-600">テスト画面</p>

        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
          <div class="sm:col-span-4">
            <label for="username" class="block text-sm font-medium leading-6 text-gray-900">API</label>
            <div class="mt-2">
